...
export const translations = {
  ar: {
    ...
    heroTitlePart1: "أفضل مولد QR Code ليوتيوب | ",
    heroTitlePart2: "فتح مباشر داخل التطبيق (Deep Link)",
    heroSubtitle: "لا تضيع مشاهداتك! أنشئ QR Code احترافي لفيديوهات وقنوات يوتيوب يفتح التطبيق مباشرة على هاتف المستخدم بدلاً من المتصفح. أداة مجانية، سريعة، ومثالية لزيادة اشتراكاتك وتفاعلك في عام 2026.",
    featFree: "مجاني 100%",
