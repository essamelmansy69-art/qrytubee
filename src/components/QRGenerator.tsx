    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full max-w-7xl mx-auto" id="qr_main_layout">
      ...
      <div className="lg:col-span-8 space-y-6" id="qr_left_panel">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-xs border border-gray-100" id="module_center_logo">
          ...
          <div className="mt-6 pt-5 border-t border-gray-100" id="terabox_promotion_container">
            <a
              ...
              <div className={`flex flex-col sm:flex-row items-center justify-between gap-4 ${lang === 'ar' ? 'sm:flex-row-reverse text-right' : 'text-left'} relative z-10`}>
                ...
                <div className={`flex flex-col sm:flex-row items-center gap-4 ${lang === 'ar' ? 'sm:flex-row-reverse' : ''} w-full sm:w-auto`}>
                  ...
                  <div className="relative shrink-0 flex items-center justify-center w-12 h-12 bg-gradient-to-br from-blue-900 to-indigo-950 border border-blue-500/35 rounded-md shadow-inner group-hover:scale-105 duration-300 transition-all">
                    {/* Glowing coins */}
                    <div className="absolute -top-1 -right-1 bg-gradient-to-r from-amber-400 to-yellow-500 text-amber-950 p-0.5 rounded-full text-[9px] font-extrabold flex items-center justify-center animate-bounce shadow-md border border-amber-300">
                      <Coins size={10} className="text-amber-950" />
                    </div>
