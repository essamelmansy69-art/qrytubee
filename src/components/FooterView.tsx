        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-5 space-y-3 font-arabic">
            ...
            <div className="flex flex-col gap-2 text-xs items-start">
              ...
              <a href="/svg" onClick={(e) => onNavigate('svg', e)} className="text-slate-300 hover:text-white cursor-pointer transition-colors block">{lang === 'ar' ? 'أداة تحويل الصورة لـ SVG' : 'Image to SVG Converter'}</a>
