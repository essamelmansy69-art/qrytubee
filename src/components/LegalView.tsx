  ...
  return (
    <div className={`bg-white rounded-3xl p-6 sm:p-10 border border-gray-100 shadow-sm max-w-3xl mx-auto ${lang === 'ar' ? 'text-right' : 'text-left'} space-y-8 animate-fadeIn`} id={`legal_${docType}_container`}>
      ...
      <div className="space-y-3 pb-5 border-b border-slate-100">
        ...
        <div className="flex items-center gap-1.5 text-xs text-slate-400 font-arabic">
          <Clock size={13} />
      ...
      <div className="text-center pt-4">
        <span className="text-[10px] text-gray-400 font-arabic block leading-relaxed max-w-md mx-auto">
          {lang === 'ar' 
