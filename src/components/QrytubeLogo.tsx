  ...
  return (
    <div className={`flex items-center gap-2.5 ${className}`} id="qrytube_brand_logo">
      ...
      >
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M 50,22 A 25,25 0 1,0 68,66 L 79,77.5 C 81,79.5 84,79.5 86.5,78 L 86.5,71.5 C 82,71.5 78.5,69 75,64.5 L 67.5,56 A 25,25 0 0,0 50,22 Z M 50,30.5 A 16.5,16.5 0 1,1 33.5,47 A 16.5,16.5 0 0,1 50,30.5 Z" fill="white"/>
